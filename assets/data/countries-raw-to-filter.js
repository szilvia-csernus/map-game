...
const filterCountries = () => {
	...
	countries.map((country) => {
		if (
			...
			country['CapitalName'] !== 'N/A' &&
			country['ContinentName'] !== 'Australia' &&
			country['ContinentName'] !== 'Antarctica' &&
			!(
			...
			countriesObject[country['CountryCode']] = {
				...
				properties: { CountryName: country['CountryName'], ContinentName: country['ContinentName'] },
			};
		}
	});
...
// After running this script in NodeJS, I filtered the data with the entries 
// I don't need:
// countries in Australia and Antarctica as well as Somaliland, Aland Islands, 
// Anguilla, Antigua and Barbuda, Aruba, Palestine, Turks and Caicor Islands,
// Comoros, British Indian Ocean Territory, Saint Martin