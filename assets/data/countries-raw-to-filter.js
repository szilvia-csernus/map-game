...
const filterCountries = () => {
	...
	countries.map((country) => {
		if (
			...
			country['CountryCode'] != 'BL' && // Saint Barthelemy
			country['CountryCode'] != 'TC' && // Turks and Caicos Islands
			country['CountryCode'] != 'KM' && // Comoros
			country['CountryCode'] != 'MS' && // Montserrat
			country['CountryCode'] != 'CW' && // Curacas
			country['CountryCode'] != 'SH' && // Saint Helena
			country['CountryCode'] != 'KN' && // Saint Kitts and Nevis
			country['CountryCode'] != 'LC' && // Saint Lucia
			country['CountryCode'] != 'PM' && // Saint Pierre and Miquelon
			country['CountryCode'] != 'VC' && // Saint Vincent and the Grenadines
			country['CountryCode'] != 'ST' && // Sao Tome and Principe
			country['CountryCode'] != 'SX' && // Sint Marteen
			country['CountryCode'] != 'SJ' && // Svalbart
			country['CountryCode'] != 'PS' && // Palestine
			country['CountryCode'] != 'TL' && // Timor-Leste
			country['CountryCode'] != 'VI' && // US Virgin Islands
			country['CountryCode'] != 'IO' && // British Indian Ocean Territory
			country['CountryCode'] != 'AX' && // Aland Islands
			country['CountryCode'] != 'AI' && // Anguilla
...
// I created countries.json file by running this script in NodeJS.